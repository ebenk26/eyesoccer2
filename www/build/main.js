...
var CommentDetailPage = (function () {
    function CommentDetailPage(storage, viewCtrl, navCtrl, navParams, http) {
    ...
    CommentDetailPage.prototype.ionViewDidEnter = function () {
        var _this = this;
    ...
    CommentDetailPage.prototype.comment = function () {
        var _this = this;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__home_home__ = __webpack_require__(34);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__ionic_storage__ = __webpack_require__(25);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var EyemeListPage = (function () {
    ...
    EyemeListPage.prototype.presentModalComment = function (pic, name, type_gallery, thumb1, title, id) {
        var _this = this;
        var modal2 = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_12__comment_detail_comment_detail__["a" /* CommentDetailPage */], { pic: pic, name: name, type_gallery: type_gallery, thumb1: thumb1, title: title, id: id });
        modal2.present();
        modal2.onDidDismiss(function (data) {
            console.log('modal data sent to main form', data);
            _this.http.get('http://eyesoccer.id/list_eyeme.php').map(function (res) { return res.json(); }).subscribe(function (data) {
                // this.posts = data.thumbnailUrl;
                _this.posts = data.data;
                console.log(data);
            }, function (err) {
    ...
    EyemeListPage.prototype.love = function (email, id_place, posts) {
    ...
    EyemeListPage.prototype.presentToast = function (text) {
        var toast = this.toastCtrl.create({
            message: text,
            duration: 3000,
            position: 'top'
